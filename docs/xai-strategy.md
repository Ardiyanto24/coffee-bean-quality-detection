...
- **Konsep → tidak dipakai, ditandai redundan.** Kenapa: TCAV adalah cara memproyeksikan representasi laten yang tidak transparan ke arah konsep yang bisa dipahami manusia. Model ini sudah transparan dari awal — 11 fiturnya SENDIRI adalah konsep yang bisa dipahami manusia (warna, luas area, densitas tepi). Memaksakan TCAV di sini menambah langkah tanpa menambah informasi baru.
